...
public class SimpleStringAdapter extends Adapter<SimpleStringAdapter.SampleViewHolder> {
   ...
   // private int itemLayoutRes;
    ...
    public SimpleStringAdapter(String[] items, boolean isStaggered) {
    ...
    public SimpleStringAdapter(List<ProductGroupContainer> items, boolean isStaggered) {
        this.items2 = items;
       // this.itemLayoutRes = R.layout.item;
        this.isStaggered = isStaggered;
    }
